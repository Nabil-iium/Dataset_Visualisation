...
Here I have shown tokenization, vectorization on tweets. For visualising the most frequent words on the dataset, I have used WordCloud. I have also shown both the positive and negative labeled tweets words which are the most frequent in the dataset.
